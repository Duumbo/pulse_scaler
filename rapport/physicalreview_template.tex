...
\title{Error Mitigation on Quantum Circuit:\\Zero-Noise Extrapolation of Using Qiskit Pulse.}% Force line breaks with \\
\thanks{A footnote to the article title}%

\author{Dimitri Bonanni-Surprenant}
 \altaffiliation[Also at ]{Physics Department, Sherbrooke University.}%Lines break automatically or can be forced with \\
...
\collaboration{eIBMq Sherbrooke}%\noaffiliation
...
\section{\label{sec:level1}Mathematical Description of the Problem}

Zero-Noise extrapolation is a technique of error mitigation.
